...
function computeReturn (cid, tradeObject, tradeResults) {
    return new Promise((resolve) => {
        ...
        const costQty = trade1.symbol.indexOf(startCoin) === 0 ? parseFloat(trade1.quantity) : trade1.quantity.mul(trade1.price)
        const resultQty = trade3.symbol.indexOf(startCoin) === 0 ? parseFloat(trade3.quantity) : trade3.quantity.mul(trade3.price)
...
console.log(2.01.sub(1.999465).sub(0.003))
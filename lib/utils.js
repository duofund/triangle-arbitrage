...
const QuantityTools = {
    ...
    trade1: (trade, vol) => {
        if (trade.symbol.indexOf(process.env.startCoin) === 0) {
            if (parseFloat(process.env.mainCoinQuantityLimit) >= 0) debugger
            console.log(parseFloat(process.env.mainCoinQuantityLimit))

...
function computeReturn (cid, tradeObject, tradeResults) {
    return new Promise((resolve) => {
        ...
        const costQty = tradeRes1.symbol.indexOf(startCoin) === 0 ? tradeRes1.executedQty : tradeRes1.executedQty.mul(tradeRes1.price)
        const resultQty = tradeRes3.symbol.indexOf(startCoin) === 0 ? tradeRes3.executedQty : tradeRes3.executedQty.mul(tradeRes3.price)

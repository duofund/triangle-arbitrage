    ...
    if (akeys[bPairTicker.key]){       
      ...
      if (stepC){
        ...
        if (comparison){
          ...
          triangle.ts = arrowTime
          const currentTime = new Date().getTime()
          triangle.trading.dir && console.log(`%c [getCandidatesFromStreamViaPath] An Order been added <${triangle.ts}> currentTime: ${currentTime}`, 'color: #999999')
